...
class Activity_Quote_Repair_Attachment(models.Model):
    activity_quote_repair_list = models.OneToOneField(Activity_Quote_Repair_List, on_delete=models.CASCADE, null=True)
    repair_area = models.ForeignKey(Repair_Area, on_delete=models.SET_NULL, null=True)
    damaged_area = models.ForeignKey(Damage_Area, on_delete=models.SET_NULL, null=True)
    repair_area_attachment = models.CharField(max_length=300, null=True)
    damaged_area_attachment = models.CharField(max_length=300, null=True)
    created_datetime =  models.DateTimeField(auto_now_add=True, null=True)
    modified_datetime =  models.DateTimeField(auto_now=True, null=True)
